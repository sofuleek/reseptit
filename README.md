...
5. Luo tietokanta suorittamalla komento `sqlite3 database.db < schema.sql` ja `sqlite3 database.db < init.sql`
...
## Sovelluksessa toimivat tällä hetkellä (30.8.) seuraavat ominaisuudet, joita voi kokeilla: 
...
- Käyttäjä voi antaa reseptille kommentin ja arvosanan.
- Käyttäjä voi myös syöttää virheellisiä tietoja, jolloin sovellus näyttää niistä virheilmoitukset.

Eli sovellus vastaa nyt asetettuja tavoitteita!
